...
export const VOCABULARY_LIST: Vocabulary[] = [
  ...
  // --- Lesson 13 ---
  { lessonId: 'L13', word: '遊びます', reading: 'あそびます', meaning: '玩', type: 'verb' },
  { lessonId: 'L13', word: '泳ぎます', reading: 'およぎます', meaning: '游泳', type: 'verb' },
  { lessonId: 'L13', word: '迎えます', reading: 'むかえます', meaning: '迎接', type: 'verb' },
  { lessonId: 'L13', word: '疲れます', reading: 'つかれます', meaning: '累', type: 'verb' },
  { lessonId: 'L13', word: '出します', reading: 'だします', meaning: '寄[信]', type: 'verb' },
  { lessonId: 'L13', word: '入ります', reading: 'はいります', meaning: '进入[咖啡馆]', type: 'verb' },
  { lessonId: 'L13', word: '出ます', reading: 'でます', meaning: '离开[咖啡馆]', type: 'verb' },
  { lessonId: 'L13', word: '結婚します', reading: 'けっこんします', meaning: '结婚', type: 'verb' },
  { lessonId: 'L13', word: '買い物します', reading: 'かいものします', meaning: '购物', type: 'verb' },
  { lessonId: 'L13', word: '食事します', reading: 'しょくじします', meaning: '用餐', type: 'verb' },
  { lessonId: 'L13', word: '散歩します', reading: 'さんぽします', meaning: '散步[在公园]', type: 'verb' },
  ...
  // --- Lesson 14 ---
  { lessonId: 'L14', word: 'つけます', reading: 'つけます', meaning: '打开(电源)', type: 'verb' },
  { lessonId: 'L14', word: '消します', reading: 'けします', meaning: '关掉(电源)', type: 'verb' },
  { lessonId: 'L14', word: '開けます', reading: 'あけます', meaning: '打开(门窗)', type: 'verb' },
  { lessonId: 'L14', word: '閉めます', reading: 'しめます', meaning: '关闭(门窗)', type: 'verb' },
  { lessonId: 'L14', word: '急ぎます', reading: 'いそぎます', meaning: '赶快', type: 'verb' },
  { lessonId: 'L14', word: '待ちます', reading: 'まちます', meaning: '等待', type: 'verb' },
  { lessonId: 'L14', word: '止めます', reading: 'とめます', meaning: '停/固定', type: 'verb' },
  { lessonId: 'L14', word: '曲がります', reading: 'まがります', meaning: '转弯', type: 'verb' },
  { lessonId: 'L14', word: '持ちます', reading: 'もちます', meaning: '持有/拿', type: 'verb' },
  { lessonId: 'L14', word: '取ります', reading: 'とります', meaning: '取/拿', type: 'verb' },
  { lessonId: 'L14', word: '手伝います', reading: 'てつだいます', meaning: '帮忙', type: 'verb' },
  { lessonId: 'L14', word: '呼びます', reading: 'よびます', meaning: '呼叫', type: 'verb' },
  { lessonId: 'L14', word: '話します', reading: 'はなします', meaning: '说话', type: 'verb' },
  { lessonId: 'L14', word: '見せます', reading: 'みせます', meaning: '出示', type: 'verb' },
  { lessonId: 'L14', word: '教えます', reading: 'おしえます', meaning: '告诉(地址)', type: 'verb' },
  { lessonId: 'L14', word: '始めます', reading: 'はじめます', meaning: '开始', type: 'verb' },
  { lessonId: 'L14', word: '降ります', reading: 'ふります', meaning: '下(雨/雪)', type: 'verb' },
  { lessonId: 'L14', word: 'コピーします', reading: 'コピーします', meaning: '复印', type: 'verb' },
  ...
  // --- Lesson 15 ---
  { lessonId: 'L15', word: '置きます', reading: 'おきます', meaning: '放/搁', type: 'verb' },
  { lessonId: 'L15', word: '作ります', reading: 'つくります', meaning: '做/制造', type: 'verb' },
  { lessonId: 'L15', word: '売ります', reading: 'うります', meaning: '卖/销售', type: 'verb' },
  { lessonId: 'L15', word: '知ります', reading: 'しります', meaning: '知道', type: 'verb' },
  { lessonId: 'L15', word: '住みます', reading: 'すみます', meaning: '居住', type: 'verb' },
  { lessonId: 'L15', word: '研究します', reading: 'けんきゅうします', meaning: '研究', type: 'verb' },
  ...
  { lessonId: 'L15', word: '思い出します', reading: 'おもいだします', meaning: '想起', type: 'verb' },
  { lessonId: 'L15', word: 'いらっしゃいます', reading: 'いらっしゃいます', meaning: '在(尊称)', type: 'verb' },
  ...
  // --- Lesson 16 ---
  { lessonId: 'L16', word: '乗ります', reading: 'のります', meaning: '乘(车/船)', type: 'verb' },
  { lessonId: 'L16', word: '降ります', reading: 'おります', meaning: '下(车/船)', type: 'verb' },
  { lessonId: 'L16', word: '乗り換えます', reading: 'のりかえます', meaning: '换乘', type: 'verb' },
  { lessonId: 'L16', word: '浴びます', reading: 'あびます', meaning: '淋(浴)', type: 'verb' },
  { lessonId: 'L16', word: '入れます', reading: 'いれます', meaning: '放入', type: 'verb' },
  { lessonId: 'L16', word: '出します', reading: 'だします', meaning: '取出/寄出', type: 'verb' },
  { lessonId: 'L16', word: '入ります', reading: 'はいります', meaning: '进入/考上', type: 'verb' },
  { lessonId: 'L16', word: '出ます', reading: 'でます', meaning: '出来/毕业', type: 'verb' },
  { lessonId: 'L16', word: 'やめます', reading: 'やめます', meaning: '辞职/戒掉', type: 'verb' },
  { lessonId: 'L16', word: '押します', reading: 'おします', meaning: '按(按钮)', type: 'verb' },
  { lessonId: 'L16', word: 'おろします', reading: 'おろします', meaning: '取(钱)', type: 'verb' },
